    ...
    r(l, [], function () {
        ...
        function n(e) {
            ...
            return i[e] ? i[e] : (l = "id accesskey class dir lang style tabindex title", u = "address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul", c = "a abbr b bdo br button cite code del dfn em embed i iframe img input ins kbd label map noscript object q s samp script select small span strong sub sup textarea u var #text #comment", "html4" != e && (l += " contenteditable contextmenu draggable dropzone hidden spellcheck translate", u += " article aside details dialog figure header footer hgroup section nav", c += " audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen"), "html5-strict" != e && (l += " xml:lang", p = "acronym applet basefont big font strike tt", c = [c, p].join(" "), s(t(p), function (e) {
                ...
                }), delete a.caption.children.table, delete a.script,
                    i[e] = a, a)
        }
        ...
        return function (l, u) {
            function c(t) {
                ...
                for (m = i("tr,td,th,tbody,thead,tfoot,table"), h = u.getNonEmptyElements(), g = u.getTextBlockElements(), v = u.getSpecialElements(), n = 0; n < t.length; n++)if (r = t[n], r.parent && !r.fixed)if (g[r.name] && "li" == r.parent.name) {
            ...
            l = l || {}, l.validate = !("validate" in l) || l.validate, l.root_name = l.root_name || "body", d.schema = u = u || new t, d.filterNode = function (e) {
                ...
                o(a(e), function (e) {
                    var n;
                    for (n = 0; n < p.length; n++)if (p[n].name === e)return void p[n].callbacks.push(t);
                ...
                if (r = r || {}, h = {}, m = {}, T = s(i("script,style,head,html,body,title,meta,param"), u.getBlockElements()), H = u.getNonEmptyElements(), O = u.children, k = l.validate, I = "forced_root_block" in r ? r.forced_root_block : l.forced_root_block, P = u.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, L = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({
                    ...
                    for (S in h) {
                        for (_ = f[S], C = h[S], E = C.length; E--;)C[E].parent || C.splice(E, 1);
                        for (x = 0, w = _.length; x < w; x++)_[x](C, S, r)
                    }
                    for (x = 0, w = p.length; x < w; x++)if (_ = p[x], _.name in m) {
                ...
                var n, r = t.length, i, o = s({}, u.getBlockElements()), a = u.getNonEmptyElements(), l, c, d, f, p, h;
                for (o.body = 1, n = 0; n < r; n++)if (i = t[n], l = i.parent, o[i.parent.name] && i === l.lastChild) {
                    for (d = i.prev; d;) {
        ...
        return function (s) {
            ...
            function x(t, n, r) {
                ...
                function o(e, t) {
                    var n = !1;
                    return !!p.selector && (ce(e, function (e) {
                ...
                function c(e, r, a) {
                    ...
                    u = p.inline || p.block, c = Y.create(u), i(c), K.walk(e, function (e) {
                        function r(e) {
                            var g, v, y, b;
                            if (b = h, g = e.nodeName.toLowerCase(), v = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && ae(e) && (b = h, h = "true" === ae(e), y = !0), B(g, "br"))return m = 0, void(p.block && Y.remove(e));
                            if (p.wrapper && N(e, t, n))return void(m = 0);
                            if (h && !y && p.block && !p.wrapper && l(g) && G(v, u))return e = Y.rename(e, u), i(e), s.push(e), void(m = 0);
                            if (p.selector) {
                                var C = o(d, e);
                                if (!p.inline || C)return void(m = 0)
                            }
                            !h || y || !G(u, g) || !G(v, u) || !a && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || f(e) || p.inline && J(e) ? (m = 0, ce(de(e.childNodes), r), y && (h = b), m = 0) : (m || (m = Y.clone(c, ne), e.parentNode.insertBefore(m, e), s.push(m)), m.appendChild(e))
                        }
                        ...
                        function t(e) {
                            "A" === e.nodeName && i(e, p), ce(de(e.childNodes), t)
                        }
                        ...
                        function o(e) {
                            var t, n;
                            return ce(e.childNodes, function (e) {
                                if (1 == e.nodeType && !ue(e) && !f(e))return t = e, ne
                            }), t && !ue(t) && A(t, p) && (n = Y.clone(t, ne), i(n), Y.replace(n, e, re), Y.remove(t, 1)), n || e
                        }

                        var a;
                        if (a = r(e), (s.length > 1 || !J(e)) && 0 === a)return void Y.remove(e, 1);
                        if (p.inline || p.wrapper) {
                            if (p.exact || 1 !== a || (e = o(e)), ce(d, function (t) {
                                    ce(Y.select(t.inline, e), function (e) {
                                        ue(e) || F(t, n, e, t.exact ? e : null)
                                    })
                                }), N(e.parentNode, t, n))return Y.remove(e, 1), e = 0, re;
                            p.merge_with_parents && Y.getParent(e.parentNode, function (r) {
                                if (N(r, t, n))return Y.remove(e, 1), e = 0, re
                            }), e && p.merge_siblings !== !1 && (e = W(U(e), e), e = W(e, U(e, re)))
                        }
                    })
                }

                var d = m(t), p = d[0], h, g, v = !r && X.isCollapsed();
                if ("false" !== ae(X.getNode())) {
                    if (p) {
                        if (r) r.nodeType ? o(d, r) || (g = Y.createRng(), g.setStartBefore(r), g.setEndAfter(r), c(H(g, d), null, !0)) : c(r, null, !0); else if (v && p.inline && !Y.select("td[data-mce-selected],th[data-mce-selected]").length) $("apply", t, n); else {
                    ...
                    r = X.getNode();
                    for (var b = 0, w = d.length; b < w; b++)if (d[b].ceFalseOverride && Y.is(r, d[b].selector))return void i(r, d[b])
                }
            }
            ...
            function w(e, t, n, r) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && ae(e) && (a = y, y = "true" === ae(e), s = !0), n = de(e.childNodes), y && !s)for (r = 0, o = p.length; r < o && !F(p[r], t, e, e); r++);
                    if (h.deep && n.length) {
                ...
                function a(e, n, r, i) {
                    ...
                    if (e) {
                        for (c = e.parentNode, o = n.parentNode; o && o != c; o = o.parentNode) {
                            for (a = Y.clone(o, ne), u = 0; u < p.length; u++)if (F(p[u], t, a, a)) {
                                a = 0;
                                break
                            }
                ...
                function f(e) {
                    ...
                    if (e = H(e, p, re), h.split) {
                        if (t = V(e, re), n = V(e), t != n) {
                            if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && u(n) && n.firstChild && (n = n.firstChild || n), Y.isChildOf(t, n) && !J(n) && !u(t) && !u(n))return t = O(t, "span", {
                                id: "_start",
                                "data-mce-type": "bookmark"
                            }), l(t), void(t = c(re));
                ...
                var p = m(e), h = p[0], g, v, y = !0;
                if (n)return void(n.nodeType ? (v = Y.createRng(), v.setStartBefore(n), v.setEndAfter(n), f(v)) : f(n));
                if ("false" !== ae(X.getNode())) X.isCollapsed() && h.inline && !Y.select("td[data-mce-selected],th[data-mce-selected]").length ? $("remove", e, t, r) : (g = X.getBookmark(), f(X.getRng(re)), X.moveToBookmark(g), h.inline && _(e, t, X.getStart()) && q(X.getRng(!0)), s.nodeChanged()); else {
                    n = X.getNode();
                    for (var C = 0, x = p.length; C < x && (!p[C].ceFalseOverride || !F(p[C], t, n, n)); C++);
                }
            }
            ...
            function T(e, t, n) {
                ...
                return ie || (ie = {}, r = {}, s.on("NodeChange", function (e) {
                    ...
                    t = i.grep(t, function (e) {
                        ...
                        ce(t, function (o) {
                            return N(o, i, {}, e.similar) ? (r[i] || (ce(e, function (e) {
            ...
            function H(t, n, r) {
                function i(e) {
                    ...
                    for (; ;) {
                        ...
                        for (o = i[a]; o; o = o[a])if (!ue(o) && !P(o) && !t(o))return i;
                ...
                function u(t, n, i) {
                    ...
                    for (a = new e(t, Y.getParent(t, J) || s.getBody()); l = a[i ? "prev" : "next"]();)if (3 === l.nodeType) {
                        if (c = l, u = o(l), u !== -1)return {container: l, offset: u}
                    } else if (J(l))break;
                ...
                return (n[0].inline || n[0].block_expand) && (n[0].inline && 3 == g.nodeType && 0 !== v || (g = i(!0)), n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = i())), n[0].selector && n[0].expand !== ne && !n[0].inline && (g = c(g, "previousSibling"), y = c(y, "nextSibling")), (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (J(g) || (g = i(!0)), J(y) || (y = i()))), 1 == g.nodeType && (v = Z(g), g = g.parentNode), 1 == y.nodeType && (b = Z(y) + 1, y = y.parentNode), {
                    startContainer: g,
                    startOffset: v,
                    endContainer: y,
                    endOffset: b
            ...
            function F(e, t, n, r) {
                ...
                }), a && "" === Y.getAttrib(n, "style") && (n.removeAttribute("style"), n.removeAttribute("data-mce-style")), ce(e.attributes, function (e, i) {
                    var o;
                    if (e = M(e, t), "number" == typeof i && (i = e, r = 0), !r || B(Y.getAttrib(r, i), e)) {
                        if ("class" == i && (e = Y.getAttrib(n, i), e && (o = "", ce(e.split(/\s+/), function (e) {
                                /mce\-\w+/.test(e) && (o += (o ? " " : "") + e)
            ...
            function z(e, t) {
                ...
                t.block && (Q ? r == Y.getRoot() && (t.list_block && B(e, t.list_block) || ce(de(e.childNodes), function (e) {
            ...
            function W(e, t) {
                ...
                if (e && t && (e = n(e, "previousSibling"), t = n(t, "nextSibling"), a.compare(e, t))) {
                    ...
                    return Y.remove(t), ce(de(t.childNodes), function (t) {
                        e.appendChild(t)
                    }), e
                }
                return t
            ...
            function $(t, n, r, i) {
                ...
                function p() {
                    var e = X.getRng(!0), t, a, s, u, c, d, f = [], p, h;
                    ...
                    if (d)if (u) s = X.getBookmark(), e.collapse(!0), e = H(e, m(n), !0), e = K.split(e), w(n, r, e), X.moveToBookmark(s); else {
                ...
                function h() {
                    var e;
                    e = u(X.getStart()), e && !Y.isEmpty(e) && fe(e, function (e) {
                ...
                s._hasCaretEvents || (le = function () {
                    var e = [], t;
                    if (a(u(X.getStart()), e))for (t = e.length; t--;)Y.setAttrib(e[t], "data-mce-bogus", "1")
                }, se = function (e) {
                    var t = e.keyCode;
            ...
            function q(t) {
                ...
                if ((t.startContainer != t.endContainer || !c(t.startContainer.childNodes[t.startOffset])) && (3 == n.nodeType && r >= n.nodeValue.length && (r = Z(n), n = n.parentNode, i = !0), 1 == n.nodeType))for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, Y.getParent(n, Y.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())if (3 == a.nodeType && !P(a))return l = Y.create("a", {"data-mce-bogus": "all"}, ee), a.parentNode.insertBefore(l, a), t.setStart(a, 0), X.setRng(t), void Y.remove(l)
            }

            var j = {}, Y = s.dom, X = s.selection, K = new t(Y), G = s.schema.isValidChild, J = Y.isBlock, Q = s.settings.forced_root_block, Z = Y.nodeIndex, ee = "\ufeff", te = /^(src|href|style)$/, ne = !1, re = !0, ie, oe, ae = Y.getContentEditable, se, le, ue = n.isBookmarkNode, ce = i.each, de = i.grep, fe = i.walk, pe = i.extend;
            pe(this, {
                get: m,
                register: g,
                unregister: v,
                ...
                formatChanged: T,
                getCssText: R
            }), p(), h(), s.on("BeforeGetContent", function (e) {
                le && "raw" != e.format && le()
        ...
        return function (e) {
            ...
            return e.on("init", function () {
                ...
                var a = t.keyCode;
                t.isDefaultPrevented() || ((a >= 33 && a <= 36 || a >= 37 && a <= 40 || 45 === a || t.ctrlKey) && (o(), e.nodeChanged()), (46 === a || 8 === a || r.mac && (91 === a || 93 === a)) && e.nodeChanged(), d && s.typing && (e.isDirty() || (i(u[0] && !n.isEq(n.createFromEditor(e), u[0])), e.isDirty() && e.fire("change", {
                    level: u[0],
                    lastLevel: null
                ...
                data: u, typing: !1, beforeChange: function () {
                    f || (c = e.selection.getBookmark(2, !0))
                }, add: function (r, o) {
                    var a, s = e.settings, d, p;
                    if (p = n.createFromEditor(e), r = r || {}, r = t.extend(r, p), f || e.removed)return null;
                    if (d = u[l], e.fire("BeforeAddUndo", {
                            level: r,
                            lastLevel: d,
                            originalEvent: o
                    ...
                    var t;
                    return s.typing && (s.add(), s.typing = !1), l > 0 && (t = u[--l], n.applyToEditor(e, t, !0), i(!0), e.fire("undo", {level: t})), t
                }, redo: function () {
                    var t;
                    return l < u.length - 1 && (t = u[++l], n.applyToEditor(e, t, !1), i(!0), e.fire("redo", {level: t})), t
                }, clear: function () {
                    u = [], l = 0, s.typing = !1, s.data = u, e.fire("ClearUndos")
                }, hasUndo: function () {
                    return l > 0 || s.typing && u[0] && !n.isEq(n.createFromEditor(e), u[0])
                }, hasRedo: function () {
                    return l < u.length - 1 && !s.typing
                }, transact: function (e) {
                    a(), s.beforeChange();
                    try {
                        f++, e()
        ...
        var l = a.matchNodeNames("td th"), u = function (a, u, c) {
            function d(e) {
                function t(e) {
            ...
            /^ | $/.test(u) && (u = d(u)), b = a.parser, A = c.merge, C = new n({validate: a.settings.validate}, a.schema), R = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', N = {
                content: u,
                format: "html",
                selection: !0
            }, a.fire("BeforeSetContent", N), u = N.content, u.indexOf("{$caret}") == -1 && (u += "{$caret}"), u = u.replace(/\{\$caret\}/, R), S = D.getRng();
            ...
            if (h(E), k = E.lastChild, "mce_marker" == k.attr("id"))for (_ = k, k = k.prev; k; k = k.walk(!0))if (3 == k.type || !L.isBlock(k.name)) {
            ...
            if (a._selectionOverrides.showBlockCaretContainer(x), O.invalid) {
                ...
                u = x == w ? w.innerHTML : L.getOuterHTML(x), u = C.serialize(b.parse(u.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
                    return C.serialize(E)
                }))), x == w ? L.setHTML(w, u) : L.setOuterHTML(x, u)
        ...
        var a = n.each, s = n.extend, l = n.map, u = n.inArray, c = n.explode, d = e.ie && e.ie < 11, f = !0, p = !1;
        return function (n) {
            function h(e, t, r, i) {
                var o, s, l = 0;
            ...
            n.on("PreInit", function () {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    T.getParent(R.getNode(), function (e) {
                        if (1 == e.nodeType && i++ == r)return R.select(e), p
                    }, n.getBody())
                    ...
                    var s = o, l, u, c, p = R.getRng(!0);
                    new r(T).normalize(p);
                    var h = p.startOffset, m = p.startContainer;
        ...
        return function (f) {
            ...
            function J() {
                function t(e) {
                    var t = new d(e.getBody()), n = e.selection.getRng(), r = c.fromRangeStart(n), i = c.fromRangeEnd(n), o = t.prev(r), a = t.next(i);
        ...
        return L.prototype = {
            render: function () {
                ...
                r.inline || (n.getElement().style.visibility = n.orgVisibility), t || r.content_editable || (p.open(), p.write(n.iframeHTML), p.close()), r.content_editable && (n.on("remove", function () {
                    ...
                    initial: !0,
                    format: "html"
                }), n.startContent = n.getContent({format: "raw"}), n.initialized = !0, n.bindPendingEventDelegates(), n.fire("init"), n.focus(!0), n.nodeChanged({initial: !0}), n.execCallback("init_instance_callback", n),
        ...
        function d(e) {
            ...
            e.addButton("undo", {
                ...
                var t = "حمید تست BBadr = BBadr;حمید تست BBaran = BBaran;حمید تست BBardiya = BBardiya;حمید تست BCompset = BCompset;حمید تست BDavat = BDavat;حمید تست BElham = BElham;حمید تست BEsfehanBold = BEsfehanBold;حمید تست BFantezy = BFantezy;حمید تست BFarnaz = BFarnaz;حمید تست BFerdosi = BFerdosi;حمید تست BHamid = BHamid;حمید تست BHelal = BHelal;حمید تست BHoma = BHoma;حمید تست BJadidBold = BJadidBold;حمید تست BJalal = BJalal;حمید تست BKoodakBold = BKoodakBold;حمید تست BKourosh = BKourosh;حمید تست BLotus = BLotus;حمید تست BMahsa = BMahsa;حمید تست BMehrBold = BMehrBold;حمید تست BMitra = BMitra;حمید تست BMorvarid = BMorvarid;حمید تست BNarm = BNarm;حمید تست BNasimBold = BNasimBold;حمید تست BNazanin = BNazanin;حمید تست BRoya = BRoya;حمید تست BSetarehBold = BSetarehBold;حمید تست BShiraz = BShiraz;حمید تست BSinaBold = BSinaBold;حمید تست BTabassom = BTabassom;حمید تست BTehran = BTehran;حمید تست BTitrBold = BTitrBold;حمید تست BTitrTGEBold = BTitrTGEBold;حمید تست BTraffic = BTraffic;حمید تست BVahidBold = BVahidBold;حمید تست BYagut = BYagut;حمید تست BYas = BYas;حمید تست BYekan = BYekan;حمید تست BZar = BZar;حمید تست BZiba = BZiba;حمید تست Entezar1 = Entezar1;حمید تست Entezar2 = Entezar2;حمید تست Entezar3 = Entezar3;حمید تست Entezar4 = Entezar4;حمید تست Entezar5 = Entezar5;حمید تست Entezar6 = Entezar6;حمید تست khat-khati = khat-khati;حمید تست khodkar = khodkar;حمید تست sols = sols;" , n = [], r = a(e.settings.font_formats || t);
