 ...
 * @link      http://www.ar-php.org
 */
if (!function_exists('I18N_Arabic_Glyphs')) {
	class I18N_Arabic_Glyphs {
		...
		public function __construct() {
			$this->_prevLink = '،؟؛ـئبتثجحخسشصضطظعغفقكلمنهی';
			$this->_nextLink = 'ـآأؤإائبةتثجحخدذرزسشصضطظعغفقكلمنهوىی';
			...
			$this->_glyphs .= 'پ' . 'چ' . 'ژ' . 'گ';
			$this->_hex .= 'FB56FB57FB58FB58FB7AFB7BFB7CFB7DFB8AFB8BFB8AFB8BFB92';
			$this->_hex .= 'FB93FB94FB95';
			//
			$this->_prevLink .= 'پ' . 'چ' . 'ژ' . 'گ';
			$this->_nextLink .= 'پ' . 'چ' . 'ژ' . 'گ';
			//
