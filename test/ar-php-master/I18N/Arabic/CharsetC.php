...
class I18N_Arabic_CharsetC
{
    ...
    public function __construct($sets = array('windows-1256', 'utf-8'))
    {
        ...
        if (in_array('windows-1256', $sets)) {
            include_once dirname(__FILE__).'/data/charset/_windows1256.php';
        }
        
        if (in_array('iso-8859-6', $sets)) {
            include_once dirname(__FILE__).'/data/charset/_iso88596.php';
        }
        
        if (in_array('utf-8', $sets)) {
            include_once dirname(__FILE__).'/data/charset/_utf8.php';
        }
        
        if (in_array('bug', $sets)) {
            include_once dirname(__FILE__).'/data/charset/_bug.php';
        }
        
        if (in_array('html', $sets)) {
            include_once dirname(__FILE__).'/data/charset/_html.php';
        }
    }
